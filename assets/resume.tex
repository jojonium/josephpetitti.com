...
\begin{itemize}[leftmargin=*,itemsep=1pt]
	\item \textbf{Languages}: JavaScript/TypeScript, Java, Kotlin, C, SQL,
		HTML/CSS, \LaTeX, Python, Bash, Haskell
	\item \textbf{Technology}: GNU/Linux, Node.js, Angular, Android, Git, Nginx,
		AWS, Vim, Eclipse, Microsoft Office
\end{itemize}
...
\section{Experience}
  \resumeSubHeadingListStart
	\resumeSubheading
	  ...
	  {Full Stack Web Developer}{Oct 2019--May 2020}
	  \resumeItemListStart
