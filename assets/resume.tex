...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    {Solid State Scientific Corporation}{Nashua, NH}
      ...
      \resumeItemListStart
          \resumeItem{Kubernetes Infrastructure} {Deployed and operated
          multi-tenant Kubernetes platform for development and production data
          processing.}
          \resumeItem{DevSecOps PaaS} {Provided modern CI/CD, platform to
          tenant developer teams.}
          \resumeItem{Public Sector Client} {Met strict DoD requirements for
          operating in government cloud environment.}
      \resumeItemListEnd
