...
\section{Experience}
  \resumeSubHeadingListStart
    \vspace{-1pt}\item
		...
		\end{tabular*}\vspace{-5pt}
      \resumeItemListStart
		  \resumeItem{Simulation Showcase} {Designed Angular front-end for
...
\resumeSubHeadingListStart
  \resumeSubheading
	...
	{Personal Project---\url{https://afterlightcaves.com}}{Nov 2019--Present}
	\resumeItemListStart
	...
	\resumeItemListStart
	\resumeItem{Full Stack Web App}{Led team of four to develop Java API
		and database in AWS, and Angular front-end.}
	\resumeItemListEnd
  \resumeSubHeadingListEnd
